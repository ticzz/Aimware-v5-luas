...
-- gui
local ui_groupbox = gui.Groupbox(gui.Reference("MISC", "Movement"), "Auto Peek", 328, 515, 297, 900)
local ui_checkbox = gui.Checkbox(gui.Reference("MISC", "Movement", "Auto Peek"), "lua_autopeek_enable", "Enable Auto Peek", true);
local ui_keybox = gui.Keybox(gui.Reference("MISC", "Movement", "Auto Peek"), "lua_autopeek_key", "Auto Peek Bind", "18");
local ui_checkbox_visualize = gui.Checkbox(gui.Reference("MISC", "Movement", "Auto Peek"), "lua_autopeek_visualize", "Visualize", true);
local ui_color_picker = gui.ColorPicker(gui.Reference("MISC", "Movement", "Auto Peek"), "lua_autopeek_outlinecol", "Outline Color", 138,43,226, 255);
local ui_color_picker2 = gui.ColorPicker(gui.Reference("MISC", "Movement", "Auto Peek"), "lua_autopeek_filcol", "Fill Color", 0,205,102, 255);
