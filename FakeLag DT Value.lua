...
local sld_nrm = gui.Slider(ref, "sld_nrm_limit", "Normal Limit", 3, 0, 17)
local sld = gui.Slider(ref, "sld_dtfl_limit", "DT Fakelag Limit", 3, 0, 17)
...
if dt and not input.IsButtonDown(gui.GetValue("rbot.antiaim.extra.fakecrouchkey")) then
