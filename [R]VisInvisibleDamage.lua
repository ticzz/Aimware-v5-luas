...
local min_damage_visible = CreatePerWeaponSlider(weapon_ref, "Chicken.dynamic_min_dmg.DamageVisible", "Damage Visible", 1, 1, 130, 1, "Min damage when aimbot target is visible.")
local min_damage_invisible = CreatePerWeaponSlider(weapon_ref, "Chicken.dynamic_min_dmg.DamageInvisible", "Damage Invisible", 1, 1, 130, 1, "Min damage when aimbot target is behind a wall")
