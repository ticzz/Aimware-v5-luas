-- Original Author: Cheeseot
-- Updated By: 3172569582
-- Translated By: Areo
local silentname = 0
local windowmade = 0
...
local knives = {
    ...
    "Shadow Daggers", "Stiletto", "Talon", "Ursus", "Classic Knife", "Paracord Knife",
    "Survival Knife", "Nomad Knife", "Skeleton Knife", "Assassin Knife",
}
...
local weaponsTable = {
    ...
    "Huntsman Knife", "Karambit", "M9 Bayonet", "Navaja",
    "Shadow Daggers", "Stiletto", "Talon", "Ursus", "Classic Knife", "Paracord Knife",
    "Survival Knife", "Nomad Knife", "Skeleton Knife", "Assassin Knife", "AWP", "AK-47", "Desert Eagle",
    "Glock-18", "M4A4", "M4A1-S", "USP-S", "Valve"
}
...
local type_messages = {
   " has opened a container and found:",
    " received in a trade:",
    " received through trade up:",
    " received through sacrificing austic teammates' parents:",
    " acquired by Admin Console:",
    ...
    local grp2 = gui.Groupbox(trolltab, "Set Name", 16,170,190,105)
     ...
     local grp3 = gui.Groupbox(trolltab, "Fake Skin", 428,16,190,315)
        msgtype = gui.Combobox(grp3, msgtype, "Message Type", "Unbox", "Trade", "Trade Up", "Sacrifice", "Console", "LOG IN")
         weapon = gui.Combobox(grp3, weapon, "Weapon", "Bayonet", "Bowie Knife", "Butterfly Knife", "Falchion Knife",
            ...
            "Talon", "Ursus","Shadow Daggers", "Stiletto", "Talon", "Ursus", "Classic Knife", "Paracord Knife",
    "Survival Knife", "Nomad Knife", "Skeleton Knife", "Assassin Knife", "AWP", "AK-47", "Desert Eagle",
        ...
        box5 = gui.Checkbox(multibox, check5, "Souvenir(NOT CURRENTLY WORKING)", 0)
    ...
    local grp9 = gui.Groupbox(trolltab, "Fake Admin Guide", 428,434,190,105)
 
    local grp10 = gui.Text(gui.Reference("Misc", "Fake", "Fake Admin Guide"),"Choose [LOG IN] at Fake Skin,Weapon [Valve],Quality(Administators),and Customize the name.")
