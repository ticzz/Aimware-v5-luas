...
local miscGroup = gui.Groupbox(privateAA, "AA Settings", 16,16,296,100)
local miscGroup2 = gui.Groupbox(privateAA, "Misc Settings", 328,16,296,100)
local miscGroup3 = gui.Groupbox(privateAA, "Fakelag Settings", 16, 290, 296, 100)

local lagSyncCheckBox = gui.Checkbox(miscGroup, "lagsync", "MM", false)
...
local privateLagCheckBox = gui.Checkbox(miscGroup3, "privateLag", "privateLag", false)
...
local function privateLag()
    if privateLagCheckBox:GetValue() == true then
